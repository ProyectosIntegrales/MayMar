                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td valign="middle">
                            ...
                            <asp:SqlDataSource ID="dsOut" runat="server" ConnectionString="<%$ ConnectionStrings:MaymarCS %>" SelectCommand="SELECT Operacion FROM Inventario WHERE (Terminado = 0) AND (ISNULL(Status, - 1) = 0) ORDER BY Operacion"></asp:SqlDataSource>
