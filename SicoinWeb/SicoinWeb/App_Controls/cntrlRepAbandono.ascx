<%@ Control Language="VB" AutoEventWireup="false" CodeFile="cntrlRepAbandono.ascx.vb"
    Inherits="cntrlRepAbandono" %>
...
<asp:Panel ID="pnlParameters" runat="server" Width="420px" CssClass="modalPopUpBig"
    BackColor="White" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" style="display:none;">
                            ...
                            <asp:Label ID="reportTitleLabel" runat="server" Text="Reporte de Causa Abandono"
            ...
            <ContentTemplate>
                ...
                <table style="width: 100%; margin-top: 10px;" cellspacing="0" cellpadding="5">
                    ...
                    <tr >
                      ...
                      <%--                  <tr >
                        <td align="right">Fecha de Causa Abandono</td>
                         <td>
                             <asp:ImageButton ID="ImageButton1" runat="server" ImageAlign="Bottom" ImageUrl="~/images/icons/16x16/calendar (1).png" style="width: 16px" />
                             <asp:TextBox ID="txtFAban" runat="server" Font-Size="8" Width="100"></asp:TextBox>
                             <asp:Image ID="Image2" runat="server" ImageAlign="Middle" ImageUrl="~/images/icons/16x16/question.png" Visible="false" />
                             <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="True" Format="MM/dd/yyyy" PopupButtonID="ImageButton1" TargetControlID="txtFAban">
                             </cc1:CalendarExtender>
                         </td>
