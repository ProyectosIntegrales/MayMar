...
<%@ Register Src="~/Admin/admExportadores.ascx" TagPrefix="uc1" TagName="admExportadores" %>
...
<div style="padding-left: 20px; padding-right: 20px;">
    ...
    <div style="display: flex; flex-direction: row; justify-content: space-between; margin-bottom: 10px;">
        <div>
            <asp:DropDownList ID="ddlSelect" runat="server" CssClass="textboxg styleSelect" AutoPostBack="True">
                ...
                <asp:ListItem Value="Exportadores">Exportadores (Anexo 29)</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div>
    ...
    <uc1:admExportadores runat="server" ID="admExportadores" Visible="false" />
</div>
