<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cntrlAbandono.aspx.vb" Inherits="App_Controls_cntrlAbandono" %>
...
<body  style="padding:5px;">
  ...
  flex-wrap: wrap;">
        <div style="width:50%">
            <p style="padding-left:4%; color: #FFF">Seleccionar mes:&nbsp;
