...
<table class="auto-style1">
    <tr>
        <td align="right" valign="top" style="width: 177px;">Caja #</td>
        <td>
    ...
    <tr>
        ...
        <td nowrap="nowrap">
            ...
            &nbsp;&nbsp;&nbsp; U. M.
            <asp:DropDownList ID="ddlUM" runat="server" CssClass="textboxg uppercase" DataSourceID="dsMedidas" DataTextField="Descripcion" DataValueField="Clave" Font-Size="8" TabIndex="14" Width="100px">
            </asp:DropDownList>
    ...
    <tr>
        ...
        <td>
            <asp:RadioButton ID="rbt1" runat="server" Checked="True" GroupName="ab" Text="45 Días" AutoPostBack="True" TabIndex="23" />
