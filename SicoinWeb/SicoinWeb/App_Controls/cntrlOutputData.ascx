...
<table class="auto-style1">
    ...
    <tr>
        ...
        <td align="right">Causa abandono</td>
        <td align="left">
                            ...
                            <tr>
                                <td align="right" colspan="2" valign="middle" style="min-height: 50px;">
                                    ...
                                    <asp:Panel ID="pnlDeclAbandono" runat="server" Visible="false" Style="border-top: 1px solid #333; margin-top: 5px;">
                                        <table>
                                            <tr>
                                                <td style="padding: 5px; width: 50%">Declaracón en abandono</td>
                                            ...
                                            <tr>
                                                <td style="padding: 5px; width: 50%">
                                                    ...
                                                    <ajaxToolkit:CalendarExtender ID="txtDeclAb_CalendarExtender" runat="server" TargetControlID="txtDeclAb"></ajaxToolkit:CalendarExtender>
                                                </td>
                                                <td style="padding: 5px; width: 50%">
                                                    <asp:TextBox ID="txtSalAb" runat="server" CssClass="textboxg uppercase" Width="100%"></asp:TextBox>
                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtSalAb"></ajaxToolkit:CalendarExtender>
                                                </td>
                                            </tr>
                                            <tr>
...
<asp:Panel ID="pnlPopUp" runat="server" CssClass="modalPopUpBig" Width="300" Height="150" Style="display: none">
    <div style="text-align: center; padding: 15px;">
        Se ha completado el total de la información de salida para<br />
        este registro.<br />
        <br />
        ¿Desea marcar esta operación como terminada?.<br />
        <br />
